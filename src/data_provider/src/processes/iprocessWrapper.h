...
class IProcessInterfaceWrapper
{
    public:
        ...
        // LCOV_EXCL_STOP
        // dbsync_processes and Linux datatype's based
        // https://github.com/wazuh/wazuh/blob/78bbd9f8e923c1a588b198ce2d0fe530659973dd/src/wazuh_modules/syscollector/src/syscollectorImp.cpp#L482
        ...
        virtual unsigned long long start_time() const = 0;
